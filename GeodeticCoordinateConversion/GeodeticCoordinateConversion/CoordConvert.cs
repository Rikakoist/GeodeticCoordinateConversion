...
{
    public partial class CoordConvert : Form
    {
        ...
        List<BL> Tab1DMS = new List<BL>();
        List<BL> Tab2DMS = new List<BL>();
                ...
                if (Tab1InputDataGridView.Rows.Count > 1)
                {
                    ...
                    for (int i = 0; i < Tab1InputDataGridView.Rows.Count - 1; i++)
                    {
                        Tab1GC.Add(new GaussCoord
                        {
                            ...
                            Type = Convert.ToInt32(Tab1InputDataGridView[5, i].Value),
        ...
        {
            E = GeoCalc.SetEllipse(EllipseMethod.SelectedIndex);
                ...
                if (Tab1InputDataGridView.Rows.Count > 1)
                {
                    ...
                    if (sender == DMSToGaussButton)
                    {
                        ...
                        for (int i = 0; i < Tab1GC.Count; i++)
                        {
                            ...
                            Tab1InputDataGridView[5, i].Value = Tab1GC[i].Type.ToString();
                            Tab1InputDataGridView[6, i].Value = Tab1GC[i].Zone.ToString();
                        }
                        SetHint("成功地将经纬度坐标转换为高斯投影" + Tab1GC[0].Type.ToString() + "°带坐标。");
                    }
                    ...
                    if (sender == GaussToDMSButton)
                    {
                        ...
                        SetHint("成功地将高斯投影" + Tab1GC[0].Type.ToString() + "°带坐标转换为经纬度坐标。");
                    }
                }
                else
                {
                    ...
                    case 0:
                        {
                            ...
                            if (sender == ReadFileToolStripMenuItem)
                            {
                                ...
                                for (int i = 0; i < T1F.Count; i++)
                                {
                                    ...
                                    Tab1InputDataGridView[5, i].Value = T1F[i].Tab1FileGC.Type.ToString();
                                ...
                                for (int i = 0; i < TmpDataGridView.Rows.Count - 1; i++)
                                {
                                    T1F.Add(new Tab1File()
                                    {
                                        ...
                                        Tab1FileGC = new GaussCoord
                                        {
                                            ...
                                            Type = Convert.ToInt32(TmpDataGridView[6, i].Value),
        ...
        private void LoadSettings(object sender, EventArgs e)
        {
            try
            {
                ...
                E = GeoCalc.SetEllipse(EllipseMethod.SelectedIndex);    //初始默认椭球
